...
void main() {
  vec3 blue1 = vec3(0.1, 0.0, 0.8);
  vec3 blue2 = vec3(0.1, 0.2, 1);
  float offsetWeight = inverseLerp(offset, 0.0, amplitude/4.0);
  vec3 modelColour = mix(blue1, blue2, offsetWeight);
